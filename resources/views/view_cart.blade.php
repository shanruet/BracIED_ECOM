...
<header class="header">
  ...
  <section class="breadcrumb-section set-bg" data-setbg="{{url('admin/img/breadcrumb.jpg')}}">
    <div class="container">
        <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="{{url('admin/img/cart/cart-1.jpg')}}" alt="">
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="{{url('admin/img/cart/cart-2.jpg')}}"  alt="">
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="{{url('admin/img/cart/cart-3.jpg')}}"  alt="">
